...
<div class="container">
    ...
    <div class="container">
      <div class="topnav2">
        ...
        <a class="active" href="registeration_admin.php">Admin</a>
        ...
        <div class="container">
          ...
          <div class="container">
              <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
                <div class="container">
                    <input type="text" name="admin_id" value="" placeholder="Admin ID" required><br>
                </div>
                <div class="container">
...
if(isset($_POST['submit'])){
		...
		$sql = "insert into admin (admin_id, name,email, password) value('".$admin_id."', '".$name."', '".$email."','".$hashPassword."')";
