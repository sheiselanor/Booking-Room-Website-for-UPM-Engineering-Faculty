...
<div class="container">
    ...
    <div class="container">
      <div class="topnav2">
        <a class="active" href="registeration.php">Student</a>
        <a href="registeration_staff.php">Staff</a>
        ...
        <div class="container">
          ...
          <div class="container">
              <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
                <div class="container">
                    <input type="text" name="matrix_id" value="" placeholder="Matrix ID" required><br>
                </div>
                <div class="container">
...
if(isset($_POST['submit'])){
		...
		$sql = "insert into student (matrix_id, name,email, password) value('".$matrix_id."', '".$name."', '".$email."','".$hashPassword."')";
