              ...
              <div class="col-xl-5 col-lg-4 d-none d-lg-block">
                <div class="book_room">
                  <div class="book_btn d-none d-lg-block">
                    <a class="popup-with-form" href="student_login.php"
                      >Book A Room</a
                    >
                  </div>
                </div>
              ...
              <div class="col-xl-12">
                <div class="slider_text text-center">
                  ...
                  <p>
                    ...
                    echo "<br>Matrix number " . $_SESSION["userID"] . ".<br>"; }
                    ?> 
        ...
        <div class="row">
          <div class="col-xl-5 col-lg-5">
            <div class="about_info">
              ...
              <p>
                Welcome to the online resource booking system for the Division of Engineering at University 
                Putra Malaysia We have a variety of study spaces and study rooms in a number of faculty 
                locations that can be booked for class and study purposes.
              </p>
          ...
          <div class="row justify-content-between">
            ...
            <div class="col-xl-3 col-md-6 col-lg-3">
              <div class="footer_widget">
                ...
                <a href="student_login.php" class="book_btn line-button">BOOK A ROOM</a>
              </div>
            </div>
