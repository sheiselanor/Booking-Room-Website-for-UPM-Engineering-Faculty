...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="topnav2">
        <a class="active" href="student_login.php">Student</a>
    ...
    <div class="row">
      <div class="container">
        <div class="container">
          <h1 class="text-align-center">Student Login</h1>
        </div>
        <div class="container">
        <form action="<?php echo $_SERVER['PHP_SELF']?>" method="post">
            <div class="container">
              <h5 class="h5login" for="matrix_id">Student ID</h5>
              <input type="text" name="matrix_id" value="" placeholder="Matrix ID" required>
            </div>
            <div class="container">
              <h5 class="h5login" for="password">Password</h5>
...
if(isset($_POST['submit'])){
	...
	$sql = "select * from student where matrix_id = '".$matrix_id."'";
